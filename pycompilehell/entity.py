...
class Entity:
    def __init__(self, texture_path, x, y, w=64, h=64):
        _ch.compilehell_create_entity.argtypes = [ctypes.c_char_p, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float]
